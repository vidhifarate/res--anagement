...
import rolesRoutes from "../feature-modules/roles/roles.routes.js";


export const routes:Routes=[authRoutes,menueRoutes,userRoutes,orderRoutes,branchRoutes,restaurantRoutes,rolesRoutes];
